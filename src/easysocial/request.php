		...
		else
		{
			...
			if ($type == 'group')
			{
				switch ($req_val)
				{
					...
					case 'withdraw':
						...
						$res->message = ($res->success) ? JText::_('PLG_API_EASYSOCIAL_REQUEST_WITHDRAWN') :
						JText::_('PLG_API_EASYSOCIAL_UNABLE_WITHDRAWN_REQ');
						break;
				}
			}
			elseif ($type == 'page')
			{
				switch ($req_val)
				{
					...
					case 'withdraw':
						$res->success = $group->deleteMember($other_user_id);
						$res->message = ($res->success) ? JText::_('PLG_API_EASYSOCIAL_PAGE_REQUEST_WITHDRAWN') :
						JText::_('PLG_API_EASYSOCIAL_PAGE_UNABLE_WITHDRAWN_REQ');
						break;
				}
			}
			else
