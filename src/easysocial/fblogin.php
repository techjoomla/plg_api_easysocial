...
class EasysocialApiResourceFblogin extends ApiResource
{
	...
	public function get()
	{
		return $this->plugin->setResponse(JText::_('PLG_API_EASYSOCIAL_UNSUPPORTED_METHOD_MESSAGE'));
	}
	...
	public function post()
	{
		...
		{
			return $this->badRequest(JText::_('PLG_API_EASYSOCIAL_BAD_REQUEST'));
		}
	}
		...
		if ($data['activation'] == 0)
		{
			...
			if ($sendpassword)
			{
				$emailBody = JText::sprintf(
											...
											\nYou can login to %s using the following username and
